    ...
    >
      <div className="p-5">
        ...
        <div className="grid grid-cols-5 my-5 mx-20">
          <input
            type="text"
            placeholder="Search by city, hotel, neighborh"
          ...
          <button
            type="submit"
            className="h-16 px-3 py-2 col-span-1 bg-green-500 text-xl hover:cursor-pointer hover:bg-green-600 text-white"
          >
        ...
        <div className="flex mx-20 my-5 font-bold">
          <button
            type="submit"
            className="h-10 px-3 py-1 hover:cursor-pointer text-white  mr-5"
          >
            Continue your search
          </button>
          <button
            type="submit"
            className="h-10 px-3 py-1 hover:cursor-pointer border-2 border-white text-white mr-5 rounded-md hover:bg-slate-600"
          >
